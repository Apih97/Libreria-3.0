...
<nav class="navbar navbar-inverse navbar-fixed-top">
    ...
    ?>
      ...
      <li class="dropdown" id="navFact">
          ...
          <ul class="dropdown-menu">            
            <li id="topNavAddFact"><a href="orders2.php?o=add"> <i class="glyphicon glyphicon-plus"></i> Añadir Orden</a></li>            
            <li id="topNavManageFact"><a href="orders2.php?o=manord"> <i class="glyphicon glyphicon-edit"></i> Manejar orden</a></li>            
          </ul>
        </li>   
