...
<nav class="navbar navbar-inverse navbar-fixed-top">
    ...
    ?>
      ...
      <li class="dropdown"> <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false"> Catalogos<span class="caret"></span></a>
          ...
          <ul class="dropdown-menu">            
            <li id="topNavAddFact"><a href="logs.php"> <i class="glyphicon glyphicon-facetime-video"></i> Logs</a></li>            
            <li id="topNavManageFact"><a href="../Reportes usuarios/reportesusuarios.php"> <i class="glyphicon glyphicon-print"></i> Reporte usuarios</a></li>    
            <li id="topNavManageFact"><a href="../Reportes productos/reportesproductos.php"> <i class="glyphicon glyphicon-print"></i> Reporte productos</a></li>
            <li id="topNavManageFact"><a href="../Reportes clientes/reportesclientes.php"> <i class="glyphicon glyphicon-print"></i> Reporte clientes</a></li>    
            <li id="topNavManageFact"><a href="../Reportes proveedores/reportesproveedores.php"> <i class="glyphicon glyphicon-print"></i> Reporte Proveedores</a></li>     
          </ul>
        </li>  
