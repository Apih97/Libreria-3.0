    ...
    ?>
      ...
      <li class="dropdown"> <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false"> Catalogos<span class="caret"></span></a>
         ...
         <li class="dropdown" id="navFact">
          ...
          <ul class="dropdown-menu">            
            <li id="topNavAddFact"><a href="../logs/logs.php"> <i class="glyphicon glyphicon-facetime-video"></i> Logs</a></li>            
            ...
            <li id="topNavManageFact"><a href="reportesclientes.php"> <i class="glyphicon glyphicon-print"></i> Reporte clientes</a></li>    
